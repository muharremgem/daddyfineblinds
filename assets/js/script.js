      ...
      TextAnimation: function () {
        ...
        function scroll_addclass() {
          ...
          $.each($lat_anim, function () {
            ...
            if (item_down >= display_aim && item_up <= display_down) {
...
// Email js Contact Form  GetFreeEstimate *****************
...
function sendMail() {
  ...
  const serviceID = "service_5m3sr4b";
  const templateID = "template_09v40nm";
...
function popMail() {
  ...
  var message = document.getElementById("recipientMessage").value;
  ...
  const serviceID = "service_5m3sr4b";
  const templateID = "template_ju8nxeh";
...
function validateEmail(recipientEmail) {
  var re =
    /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
  return re.test(String(recipientEmail).toLowerCase());
}
